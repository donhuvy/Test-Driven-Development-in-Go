...
import (
	...
	"github.com/donhuvy/Test-Driven-Development-in-Go/chapter09/db"
	"github.com/donhuvy/Test-Driven-Development-in-Go/chapter09/handlers"
...
func main() {
	...
	m, err := migrate.New("file://chapter09/db/migrations", postgresURL)
	if err != nil {
